...
[Gitlab 2017](https://about.gitlab.com/2017/02/01/gitlab-dot-com-database-incident/). Influx of requests overloaded the database, caused replication to lag, tired admin deleted the wrong directory, six hours of data lost. See also [HN discussion](https://news.ycombinator.com/item?id=13537052).
